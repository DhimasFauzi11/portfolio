...
export default function About() {
  return (
    <section id="about" className="py-24 relative overflow-hidden">
      ...
      <div className="absolute -top-24 -left-24 w-[420px] h-[420px] bg-[#00bd95]/10 blur-3xl rounded-full" />
      <div className="absolute -bottom-24 -right-24 w-[520px] h-[520px] bg-[#00bd95]/10 blur-3xl rounded-full" />
      ...
      <div className="max-w-screen-xl mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="relative rounded-3xl border border-[#00bd95]/20 bg-[#20272f]/70 backdrop-blur-sm overflow-hidden shadow-2xl">
              ...
              <div className="p-6 md:p-8">
                <div className="flex items-center justify-between mb-5">
                  ...
                  <span className="text-xs text-gray-400 border border-gray-700/60 px-3 py-1 rounded-full">
                ...
                <div className="relative">
                  ...
                  <div className="relative rounded-full h-[370px] w-[370px] mx-auto overflow-hidden border border-gray-800/60">
                    <img
                      src={aboutPic}
                      alt="About profile"
                      className="w-full h-fit md:h-[430px] object-cover"
                      loading="lazy"
                      draggable={false}
                    />
                    {/* overlay for theme */}
                  ...
                  <div className="absolute -right-4 bottom-8 bg-[#20272f]/85 border border-gray-800/60 rounded-xl px-4 py-3 shadow-lg backdrop-blur">
          ...
          <div className="space-y-6">
            <div className="bg-[#20272f]/70 backdrop-blur-sm p-8 rounded-2xl border border-[#00bd95]/20 shadow-xl hover:border-[#00bd95]/40 transition-colors">
              <h3 className="text-2xl font-bold text-[#00bd95] mb-4">
                Summary
              </h3>
              <p className="text-gray-300 text-[16px] leading-relaxed text-justify">
                ...
                in technologies such as Tailwind CSS, React.js, and express.Js. In addition, I have leadership experience and strong
            ...
            <div className="bg-[#20272f]/70 backdrop-blur-sm p-8 rounded-2xl border border-[#00bd95]/20 shadow-xl hover:border-[#00bd95]/40 transition-colors">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-400 text-[15px]">
                  Bachelor of Engineering – Mechatronics and Artificial Intelligence
                </p>
                <p className="text-[#00bd95] font-semibold text-[15px]">GPA: 3.66/4.00</p>
                <p className="text-gray-500">August 2023 – Present</p>
              </div>
