...
import aboutPic from "../assets/profil.png";
          ...
          <div className="space-y-5 md:space-y-6">
            <div className="bg-[#1f1f23]/70 backdrop-blur-sm p-6 sm:p-7 md:p-8 rounded-2xl border border-[#ea580c]/20 shadow-xl hover:border-[#ea580c]/40 transition-colors">
              ...
              <p className="text-gray-300 text-sm sm:text-[15px] md:text-[16px] text-justify leading-relaxed">
                I am an Undergraduate student in Mechatronics and Artificial Intelligence with strong interest  in software development,  data analysis, and UI/UX. Skilled in front-end development, application logic implementation, data processing, predictive modeling and integrating machine learning model outputs into intelligent web-based systems. Passionate about designing intelligent systems and software solutions to address real world problems through data driven approaches. Seeking roles as an Software Engineer related to Software Development, AI/Machine Learning Engineer, or UI/UX Designer
              </p>
            </div>
            ...
            <div className="bg-[#1f1f23]/70 backdrop-blur-sm p-6 sm:p-7 md:p-8 rounded-2xl border border-[#ea580c]/20 shadow-xl hover:border-[#ea580c]/40 transition-colors">
              ...
              <div className="space-y-2">
                ...
                <p className="text-[#ea580c] font-semibold text-[14px] sm:text-[15px]">
                  GPA: 3.54 / 4.00
                </p>
