import { ChevronDown, FileMinus, Linkedin } from "lucide-react";
import heroPoster from "../assets/vector.png";
        ...
        <div className="grid md:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-6 mr-6 animate-fade-in">
            ...
            <div className="flex gap-9 pt-4">
              ...
              <a
                href="https://drive.google.com/file/d/1x9nw_zepczpKPJqK80cSISISwYy_NuOb/view"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="View Curriculum Vitae PDF"
              >
                <button
                  className="flex items-center gap-2 px-4 md:px-8 py-3
                    border-2 border-[#ea580c]
                    bg-[#1a1a1f] hover:bg-[#ea580c1a]
                    rounded-lg font-semibold transition-all duration-300
                    transform hover:scale-105 hover:shadow-xl text-white"
                >
